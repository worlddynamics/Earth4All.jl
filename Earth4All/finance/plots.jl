...
fig_fin_2(; kwargs...) = plotvariables(finance_run_solution(), (t, 1980, 2100), _variables_fin_2(); title="Finance sector plots", showaxis=true, showlegend=true, kwargs...)

#correct PU, ISR quite ok, IR salto strano
