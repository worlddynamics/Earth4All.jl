...
function foodland(; name, params=_params, inits=_inits, tables=_tables, ranges=_ranges)
    ...
    @variables ALFL(t) [description = "Acceptable Loss of Forestry Land"]
    ...
    @variables CEM(t) [description = "Cropland Expansion Multiplier"]
    @variables CIRA(t) [description = "Cost Index for Regenerative Agriculture"]
    @variables CO2AFL(t) [description = "CO2 Absorption in Forestry Land GtCO2/y"]
    @variables CO2AFLH(t) [description = "CO2 Absorption in Forestry Land per Ha tCO2/ha/y"]
    @variables CO2ELULUC(t) [description = "CO2 Emissions from LULUC GtCO2/y"]
    @variables CO2ELY(t) [description = "CO2 Effect on Land Yield"]
    ...
    @variables CRBA(t) [description = "CRop BAlance"]
    ...
    @variables CRSU(t) [description = "CRop SUpply (after 20 percent waste) Mt-crop/y"]
    ...
    @variables ECFTSGDP(t) [description = "Extra Cost of Food Turnaround as Share of GDP"]
    ...
    @variables FAM(t) [description = "Forest Absorption Multipler"]
    @variables FCR(t) [description = "Fertilizer Cost Reduction Gdollar/y"]
    @variables FEER(t) [description = "Fertilizer Effect on Erosion Rate"]
    ...
    @variables FFLR(t) [description = "Fraction Forestry Land Remaining"]
    @variables FFLREOGRR(t) [description = "FFLReoOGRR: Fraction Forestry Land Remaining Effect on Old Growth Removal Rate"]
    @variables FNRM(t) [description = "Fraction New Red Meat"]
    ...
    @variables FRA(t) [description = "Fraction Regenerative Agriculture"]
    ...
    @variables LERM(t) [description = "Land ERosion Multiplier"]
    ...
    @variables NDRA(t) [description = "Number of Doublings in Reg Ag"]
    ...
    @variables WELY(t) [description = "Warming Effect on Land Yield"]
    ...
    add_equation!(eqs, BIUS ~ interpolate1(t, [(1980.0, 0.0), (1990.0, 0.0), (2000.0, 0.0), (2020.0, 0.0), (2100.0, 0.0)]))
    ...
    add_equation!(eqs, TFUCA ~ interpolate1(DCYCA, [(1.0, 0.0), (2.0, 40.0), (2.5, 50.0), (3.0, 60.0), (3.5, 70.0), (4.5, 100.0), (6.5, 200.0), (10.0, 600.0)]))
    add_equation!(eqs, TUC ~ TUCP * POP / 1000)
    add_equation!(eqs, TUCERM ~ (TUC - TUFRM) / FSPI)
    add_equation!(eqs, TUCERMP ~ TUCERM * 1000 / POP)
    add_equation!(eqs, TUCP ~ interpolate1(GDPP, [(0.0, 400.0), (6.1, 680.0), (8.7, 780.0), (13.9, 950.0), (20.0, 1050.0), (30.0, 1150.0), (40.0, 1250.0), (60.0, 1350.0), (100.0, 1550.0)]))
...
function foodland_support(; name, params=_params, inits=_inits, tables=_tables, ranges=_ranges)
