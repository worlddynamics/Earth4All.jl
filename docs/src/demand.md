...
```@raw html
<div align="center"><img src="../imgs/graphics/OSFvsEGDPP.png" alt="Relationship between the owner saving fraction and the effective GDP per person" width="600" height="600"></div>
```
